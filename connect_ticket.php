...
<body>
	<div class="container">
		<div class="header">
			...
			<h2 class =" heading">Insert Ticket Information</h2>
			<form action="connect_ticket.php" method="POST">
<div class="a">
...
$sql="INSERT INTO tb_ticket(ID,SN,Price) VALUES('$_POST[ID]','$_POST[SN]','$_POST[Price]')";
