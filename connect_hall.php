...
<body>
	<div class="container">
		<div class="header">
			...
			<h2 class =" heading">Insert Hall Information</h2>
			<form action="connect_hall.php" method="POST">
	<div class="a">
	<p>ID:<br>
	...
	<p>Seat Number:<br>
		<input type="text" name="Sn" value=""></p>
...
$sql="INSERT INTO tb_hall(ID,Name,Type,SeatNo) VALUES('$_POST[ID]','$_POST[Name]','$_POST[Type]','$_POST[Sn]')";
